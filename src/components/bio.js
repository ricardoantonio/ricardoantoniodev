...
const socialMedia = [
  {
    media: "twitter",
    link: "https://twitter.com/rantoniodev",
    icon: (
  ...
  {
    media: "linkedin",
    link: "https://www.linkedin.com/in/ricardoantoniodev/",
    icon: (
  ...
  {
    media: "github",
    link: "https://github.com/ricardoantonio",
    icon: (
  ...
  return (
    <div className={bioContainer}>
      ...
      <p className={heroDescription}>
        ...
        las tecnologías de la información, en constante aprendizaje y deseando
        colaborar contigo.
      </p>
            ...
            <li key={media.media}>
              <a href={media.link}>
                <svg
                  ...
                  viewBox="0 0 512 512"
                  style={{ ...mediaIcon, fill: media.color }}
                >
                  {media.icon}
                </svg>
              </a>
